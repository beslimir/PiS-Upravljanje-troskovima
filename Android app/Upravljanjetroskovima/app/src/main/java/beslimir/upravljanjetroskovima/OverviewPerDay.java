...
public class OverviewPerDay extends AppCompatActivity {
    ...
    public void populateListView(){
        Cursor getChargeEntriesByCategoryNow = monthDB.getChargeEntriesByCategoryD(myDate);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent i = new Intent(OverviewPerDay.this, MainActivity.class);
