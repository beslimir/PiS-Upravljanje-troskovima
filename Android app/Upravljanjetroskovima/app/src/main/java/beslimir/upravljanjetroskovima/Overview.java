...
public class Overview extends AppCompatActivity {
    ...
    public void populateListView(){
        Cursor getChargeEntriesByCategoryNow = monthDB.getChargeEntriesByCategory();
    ...
    public void getTotalCharge(){
        Cursor getTotalChargeNow = monthDB.getTotalCharge();
        Cursor getTotalChargeMinusNow = monthDB.getTotalChargeMinus();
